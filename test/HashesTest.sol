...
contract HashesTest is Test {
    ...
    function testEdgeCases() public pure {
        ...
        assertEq(
            resultWithZero,
            efficientResultWithZero,
            "commutativeKeccak256 should match efficientKeccak256 with zero input"
        );
        assertEq(
            efficientResultWithZero, nonEfficientResultWithZero, "Both implementations should match with zero input"
        );
    }
